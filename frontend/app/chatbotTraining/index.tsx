            ...
            <View style={styles.itemHeader}>
                ...
                <View style={styles.switchContainer}>
                    ...
                    <Switch
                        ...
                        thumbColor={Platform.OS === 'ios' ? '#fff' : (editingItem?.is_active ? colors.tint : colors.surface)}
                    />
                </View>
            </View>
    ...
    const renderAddForm = () => (
        <View style={styles.addCard}>
            ...
            <TouchableOpacity onPress={handleAddTraining} activeOpacity={0.8}>
                <LinearGradient colors={[colors.tint, colors.tint + 'CC']} style={styles.addButton}>
...
function getStyles(colors: any, activeScheme: string) {
  return StyleSheet.create({
    ...
    headerButton: { width: 40, height: 40, borderRadius: 20, backgroundColor: colors.surface, justifyContent: 'center', alignItems: 'center' },
    ...
    addCard: { backgroundColor: colors.surface, borderRadius: 24, padding: 24, marginBottom: 24, borderWidth: 1, borderColor: colors.border, width: isMobile ? '98%' : '100%', alignSelf: 'center' },
    sectionTitle: { fontSize: 18, fontWeight: '800', color: colors.text, marginBottom: 20, letterSpacing: -0.3 },
    inputGroup: { marginBottom: 16 },
    inputLabel: { fontSize: 13, fontWeight: '700', color: colors.textSecondary, marginBottom: 8, textTransform: 'uppercase', letterSpacing: 0.5 },
    ...
    reviewText: { color: colors.error, fontSize: 13, fontWeight: '600' },
    itemCard: { backgroundColor: colors.surface, borderRadius: 20, padding: 20, marginBottom: 16, borderWidth: 1, borderColor: colors.border, width: isMobile ? '98%' : '100%', alignSelf: 'center', ...createShadow({ opacity: 0.05, radius: 10 }) },
    ...
    categoryPillText: { color: colors.tint, fontSize: 12, fontWeight: '700', textTransform: 'uppercase' },
    switchContainer: { flexDirection: 'row', alignItems: 'center', gap: 8 },
    activeLabel: { fontSize: 12, fontWeight: '600', color: colors.textSecondary },
    itemLabel: { fontSize: 11, fontWeight: '800', color: colors.textSecondary + '80', textTransform: 'uppercase', marginBottom: 4, letterSpacing: 1 },
    itemInput: { fontSize: 15, fontWeight: '500', color: colors.text, paddingBottom: 12, marginBottom: 12, borderBottomWidth: 1, borderBottomColor: colors.border },
