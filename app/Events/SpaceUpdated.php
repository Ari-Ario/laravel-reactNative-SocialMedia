    ...
    public function broadcastWith()
    {
        ...
        return [
            'space' => [
                ...
                'settings' => is_string($this->space->settings) ? json_decode($this->space->settings, true) : $this->space->settings,
                ...
                'participations' => $this->space->relationLoaded('participations') ? $this->space->participations->load('user:id,name,username,profile_photo') : $this->space->participations()->with('user:id,name,username,profile_photo')->get(),
            ],
