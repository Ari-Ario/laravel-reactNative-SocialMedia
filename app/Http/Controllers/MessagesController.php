...
class MessagesController extends Controller
{
    ...
    public function broadcast(Request $request)
    {
        $request->validate([
            ...
            'type' => 'sometimes|string|in:text,image,video,document,voice,poll,post_share,ai_idea_share',
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'type' => 'required|in:text,image,video,document,voice,poll,post_share,ai_idea_share',
